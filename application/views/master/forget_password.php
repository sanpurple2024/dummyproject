...
<html lang="en">
	<head>
		...
		<title>Swadisha I Fast build Admin dashboard for any platform</title>
		<meta name="description" content="Swadisha is a Dashboard & Admin Site Responsive Template by hencework." />
		<meta name="keywords" content="admin, admin dashboard, admin template, cms, crm, Swadisha Admin, Swadishaadmin, premium admin templates, responsive admin, sass, panel, software, ui, visualization, web app, application" />
									...
									<div class="col-sm-12 col-xs-12">
										<div class="sp-logo-wrap text-center pa-0 mb-30">
											<a href="index.html">
												...
												<span class="brand-text">Swadisha</span>
											</a>
										</div>
										<div class="mb-30">
											<h3 class="text-center txt-dark mb-10">Need help with your password?</h3>
											<h6 class="text-center txt-grey nonecase-font">Enter the email you use for Swadisha, and we’ll help you create a new password.</h6>
										</div>	
										<div class="form-wrap">
											<form action="#" id="admin_forget_passsword" method="POST">
