							...
							<div class="panel panel-default card-view">
								...
								<div class="panel-wrapper collapse in">
									<div class="panel-body">
									    ...
									    <form enctype="multipart/form-data" id="add_testimonial" method="POST" >
											...
											<input type="text" class="form-control" id="" placeholder="Client name" name="client_name" required=""  required>
