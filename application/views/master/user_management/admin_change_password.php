					...
					<div class="row heading-bg">
						...
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
							<ol class="breadcrumb">
								...
								<li><a href="<?php echo base_url();?>master/ad_change_password"><span>Change Password</span></a></li>
								...
								<div class="panel-wrapper collapse in">
									<div class="panel-body">
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-wrap">
													<form enctype="multipart/form-data" id="admin_change_password" method="POST" >
														<div class="form-group">
															<label for="inputcur_pwd" class="control-label mb-10">Old Password</label>
															<input type="password" value="" class="form-control" name="cur_pwd"  id="inputcur_pwd" placeholder="Enter Old Password" required>
														</div>
